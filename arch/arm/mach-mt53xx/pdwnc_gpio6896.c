...
#elif defined(CONFIG_ARCH_MT5895)
#include <mach/mt5895/x_gpio_hw.h>
#elif defined(CONFIG_ARCH_MT5863)
#include <mach/mt5863/x_gpio_hw.h>
#elif defined(CONFIG_ARCH_MT5866)
#include <mach/mt5866/x_gpio_hw.h>
#endif
...
#if defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5895)
	else
	{
...
#elif defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5886) || defined(CONFIG_ARCH_MT5895)
	if(i4Int <= 31)
	{
...
#if defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5893) ||  defined(CONFIG_ARCH_MT5882) \
    ||  defined(CONFIG_ARCH_MT5865) || defined(CONFIG_ARCH_MT5886) || defined(CONFIG_ARCH_MT5863) \
...
unsigned int  mtk_servoadc_readchannelvalue(unsigned int u4Channel)
{
	...
	#if defined(CONFIG_ARCH_MT5865) || defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5893) \
