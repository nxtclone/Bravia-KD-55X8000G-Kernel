...
#if defined(CONFIG_ARCH_MT5399) || defined(CONFIG_ARCH_MT5398) || defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5886) || defined(CONFIG_ARCH_MT5895)
...
#if defined(CONFIG_ARCH_MT5882)||defined(CONFIG_ARCH_MT5865) ||defined(CONFIG_ARCH_MT5863) || defined(CONFIG_ARCH_MT5866)
//#define XTAL_STRAP_MODE         (CKGEN_READ32(0) & 0x2000)
#define IS_XTAL_54MHZ()         0
#define IS_XTAL_60MHZ()         0
...
void __init mt53xx_timer_init(void)
{
    ...
    mt53xx_twd_init();
        ...
        || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5866) || defined(CONFIG_ARCH_MT5895) \
    ...
    ||  defined(CONFIG_ARCH_MT5863) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5866) || defined(CONFIG_ARCH_MT5895)
...
#endif //  defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5886) || defined(CONFIG_ARCH_MT5863) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5866) || defined(CONFIG_ARCH_MT5895)
