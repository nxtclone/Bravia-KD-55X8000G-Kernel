...
{
#if !defined(CONFIG_ARCH_MT5891) && !defined(CONFIG_ARCH_MT5893) && !defined(CONFIG_ARCH_MT5886) && !defined(CONFIG_ARCH_MT5863) && !defined(CONFIG_ARCH_MT5866) && !defined(CONFIG_ARCH_MT5895)
	unsigned int v;
 ...
 */
void platform_cpu_die(unsigned int cpu) // access .cpuinit.data:pen_release; TODO
{
	unsigned int phyCpu;
#ifdef DEBUG
...
extern void platform_smp_prepare_cpus_wakeup(void);
extern void platform_smp_prepare_cpus_boot(void);
