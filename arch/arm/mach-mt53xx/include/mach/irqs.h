...
#elif defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5886) \
...
#define NR_IRQS         160
#elif defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5886) \
    || defined(CONFIG_ARCH_MT5863) || defined(CONFIG_ARCH_MT5866)
#define NR_IRQS         288
...
#define VECTOR_TVE          (6+VECTOR_MISC_BASE)          // 6. TVE interrupt
    ...
    || defined(CONFIG_ARCH_MT5882)||defined(CONFIG_ARCH_MT5865) || defined(CONFIG_ARCH_MT5891) \
    || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5886) || defined(CONFIG_ARCH_MT5863) \
...
#if defined(CONFIG_ARCH_MT5865) || defined(CONFIG_ARCH_MT5863) || defined(CONFIG_ARCH_MT5866)
#define VECTOR_I2C          (21+VECTOR_MISC_BASE)
#else
#define VECTOR_GFX3D_GP     (21+VECTOR_MISC_BASE)
#endif
#if defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5891) || defined(CONFIG_ARCH_MT5893) || defined(CONFIG_ARCH_MT5886) || defined(CONFIG_ARCH_MT5895)
#define VECTOR_SSUSB_DEVICE (24+VECTOR_MISC_BASE)
#endif
#if !defined(CONFIG_ARCH_MT5399)  && !defined(CONFIG_ARCH_MT5886) && !defined(CONFIG_ARCH_MT5890) && !defined(CONFIG_ARCH_MT5891) && !defined(CONFIG_ARCH_MT5893) && !defined(CONFIG_ARCH_MT5895) || defined(CONFIG_ARCH_MT5861) || defined(CONFIG_ARCH_MT5882)||defined(CONFIG_ARCH_MT5865)
...
#if defined (CONFIG_ARCH_MT5399) || defined (CONFIG_ARCH_MT5890) || defined (CONFIG_ARCH_MT5891) \
...
#endif
#if defined(CONFIG_ARCH_MT5890)|| defined(CONFIG_ARCH_MT5882) || defined(CONFIG_ARCH_MT5865) \
