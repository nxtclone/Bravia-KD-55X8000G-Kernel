...
static void sysrq_show_all_interrupts(int key)
{
	sysrq_show_interrupts();
}

static struct sysrq_key_op sysrq_show_interrupts_op = {
	.handler	= sysrq_show_all_interrupts,
	.help_msg	= "show-all-interrupts(y)",
	.action_msg	= "Show All Interrupts",
};
#endif
