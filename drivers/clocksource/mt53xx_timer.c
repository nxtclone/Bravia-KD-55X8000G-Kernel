...
#endif
static int mt53xx_time_shutdown(struct clock_event_device *evt_dev)
{
	unsigned long ctrl;
	struct mt53xx_timer *timer = container_of(evt_dev,
						  struct mt53xx_timer, evt);
...
static int mt53xx_time_periodic(struct clock_event_device *evt_dev)
{
	unsigned long ctrl;
	struct mt53xx_timer *timer = container_of(evt_dev,
						  struct mt53xx_timer, evt);
...
static int mt53xx_time_oneshot(struct clock_event_device *evt_dev)
{
	unsigned long ctrl;
	struct mt53xx_timer *timer = container_of(evt_dev,
						  struct mt53xx_timer, evt);
...
static int __init mt53xx_timer_init(struct device_node *node)
{
	void __iomem *base;
	...
	timer->evt.set_state_shutdown = mt53xx_time_shutdown;
	timer->evt.set_state_periodic = mt53xx_time_periodic;
	timer->evt.set_state_oneshot = mt53xx_time_oneshot;
